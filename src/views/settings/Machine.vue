                           ...
                           <div class="col-md-12">
                              <div style="white-space: nowrap; overflow-x: auto">
                                 <table class="table">
                                    ...
                                    <tbody>
                                       <tr v-for="(item,index) in machine_items" v-bind:key="index">
                                          <td>{{item._id}}</td>
                                          <td>{{item.machine_name}}</td>
                                          <td>{{item.model}}</td>
                                          <td>
                                            <div class="text-center">
                                                 <img :src="item.url" style="width:100px;hight:100px" class="rounded" alt="">
                                             </div>
                                          </td>
   ...
   export default {
    ...
    getActionName(){
     ...
     methods: {
       ...
       async LoadData(){
           await service.getAllMachine().then((res) => {
              this.machine_items=res
           })
           .catch((e) => {
             //console.log(e);
